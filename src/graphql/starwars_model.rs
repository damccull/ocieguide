...
impl QueryRoot {
    async fn hero(
        ...
        ctx: &Context<'_>,
        #[graphql(
            desc = "If omitted, returns the hero of the whole safa. If provided, returns the hero of that particular episode."
        )]
...
impl Human {
    ...
    /// The home planet of the human, or `None` if unknown.
...
impl Droid {
    ...
    /// The home planet of the droid, or `None` if unknown.
